...
namespace slothLib {
  ...
  std::ostream &operator<<(std::ostream &os, const std::pair<T1, T2> &p) {
     ...
     * tecnique, it is based on TreePosVector container. The priority of the
     * values is based on the Key.
     *
     * \author Nico Fiorini
     */
    ...
    template <class K, class T> class DHeap {
      ...
      public:
         ...
         *
         * This function inserts the specified key-value pair into the D-ary
         * heap.
         *
         ...
         *
         * @note The heap will be updated to maintain its heap property after
         ...
         *
         * @note If the key is not present in the data structure, a new
         ...
         *
         * This operator allows you to stream the contents of a DHeap object to
         * an output stream.
         *
         * @param os The output stream to which the DHeap object is streamed.
         * @param heap The DHeap object to be streamed.
         * @return The same output stream (`os`) after streaming the DHeap
         * object.
         */
         ...
         *
         * This operator allows you to read data from an input stream and
         * populate a DHeap object with it.
         *
